#This is your Week 6 project. You will analyze 28 days of SMP member fitness data using pandas and NumPy.
# The project covers every skill from this week: loading and inspecting data, filtering, grouping, computing statistics, and producing a structured report.

# What You Will Build
# 1. Load a 28-day fitness log into a DataFrame
# 2. Inspect and clean the data (handle any missing values)
# 3. Filter for high-performance days and specific protocols
# 4. Group by fasting protocol to compare average metrics
# 5. Compute NumPy statistics on key columns
# 6. Output a formatted weekly and monthly summary report
