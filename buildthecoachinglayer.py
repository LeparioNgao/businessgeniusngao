# Step 2: Build the coaching layer.

#The coaching layer receives the prediction result and the input values, then returns a structured coaching message.
# In production this calls the OpenAI Chat API. In this browser terminal it uses the same response structure with simulated output.
